...
<div class="row no-gutters mt-5">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-6 mt-2 pr-3 pl-3 pt-4">
        <form method="post" action="keranjang_aksi.php" class="form-inline">
    ...
    <table class="table table-bordered mt-4 pr-3 pt-4">
        <tr>
            <th>Nama</th>
            <th>Harga</th>
            <th>Qty</th>
        ...
        <tr>
            ...
            <td><a href="keranjang_hapus.php?id=<?=$value['id']?>" class="btn btn-danger"><i class="fas fa-window-close"></i></a></td>
        </tr>
        <?php } ?>
        <?php endif; ?>
    </table>
    <button type="submit" class="btn btn-success">Perbaharui</button>
    <a href="keranjang_reset.php" class="btn btn-warning">Reset Keranjang</a>
    </form>
    </div>
