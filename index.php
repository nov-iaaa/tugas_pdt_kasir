...
<div class="row no-gutters mt-5">
  ...
  <div class="container no-gutters mt-2">
  ...
  <div class="card-body">
    ...
    if (hour >= 4 && hour < 10) {
      return "Selamat pagi Novi:)";
    } else if (hour >= 10 && hour < 15) {
      return "Selamat siang Novi:)";
    } else if (hour >= 15 && hour < 18) {
      return "Selamat sore Novi:)";
    } else {
      return "Selamat malam Novi:)";
    }
  }
